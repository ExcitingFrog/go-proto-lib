...
import (
	...
	"github.com/ExcitingFrog/go-proto-lib/rest/xuanwu/swagger/client/models"
)
...
func (o *HelloTraceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /hello/trace] helloTrace", response, response.Code())
	}
}
